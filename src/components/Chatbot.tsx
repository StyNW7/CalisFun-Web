...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "Halo! Saya adalah asisten CalisFun. Bagaimana saya bisa membantu Anda hari ini?",
      sender: "bot",
      timestamp: new Date(),
    },
  ])
...
//   }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-t-2xl text-white">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
              <Bot className="w-4 h-4" />
            </div>
            <div>
              <h3 className="font-semibold text-sm">CalisFun Assistant</h3>
